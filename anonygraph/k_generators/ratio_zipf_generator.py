...
class RatioZipfGenerator(BaseGenerator):
    def __init__(self, min_k_ratio, max_k_ratio, step_k_ratio, param=0.6):
        ...
        logger.debug("({}, {}, {}) - param: {}".format(self.min_k_ratio, self.max_k_ratio, self.step_k_ratio, self.param))

    def generate_k_values(self, entity_ids, graph):
        num_entities = len(entity_ids)

        # generate k values
        max_k = int(num_entities * self.max_k_ratio) + 1
